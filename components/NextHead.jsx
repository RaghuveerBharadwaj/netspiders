...
export const NextHead = () => {
  return (
    <Head>
      <title>Digital Marketing Agency Mysore | Netspiders </title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0WQB5VDFYN"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-0WQB5VDFYN');
</script>
    </Head>
  )
}
